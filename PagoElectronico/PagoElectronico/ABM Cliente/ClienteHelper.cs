    ...
    { 
        ...
        public static Cliente getClientData(String clientId)
        {
            ...
            if (reader.HasRows)
            {
                ...
                clientData.username = Convert.ToString(reader["Username"]);
        ...
        public static Int32 save(Cliente clientData)
        {
            ...
            sp_save_or_update_client.Parameters.AddWithValue("@p_user_username", clientData.username);
            sp_save_or_update_client.Parameters.AddWithValue("@p_user_password", clientData.password);
            sp_save_or_update_client.Parameters.AddWithValue("@p_user_secret_question", clientData.secret_question);
            sp_save_or_update_client.Parameters.AddWithValue("@p_user_secret_answer", clientData.secret_answer);
